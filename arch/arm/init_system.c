...
void stop_mmu(void)
{
   int r0;
	...
	__asm__(
		"mrc    p15, 0, r0, c1, c0, 0\n"    /* 闁跨喐鏋婚幏鐑芥晸閺傘倖瀚归柨鐔告灮閹风兘鏁撻悪鈥崇槑鏉堢偓瀚归柨鐔告灮閹风兘鏁撻弬銈嗗閸婏拷 */

		                                /* .RVI ..RS B... .CAM */
		"bic    r0, r0, #0x3000\n"          /* ..11 .... .... .... 闁跨喐鏋婚幏鐑芥晸缁插秹鏁撻弬銈嗗I娴ｏ拷 */
		"bic    r0, r0, #0x0300\n"          /* .... ..11 .... .... 闁跨喐鏋婚幏鐑芥晸缁插鏁撻弬銈嗗S娴ｏ拷 */
		"bic    r0, r0, #0x0087\n"          /* .... .... 1... .111 闁跨喐鏋婚幏鐑芥晸缁憋拷/C/A/M */
		"bic    r0, r0, #0x0001\n"          /* .... .... .... ...1 闁跨喐鏋婚幏閿嬵剾MMU */

		"mcr    p15, 0, r0, c1, c0, 0\n"    /* 闁跨喐鏋婚幏鐑芥晸閻偅鏁肩喊澶嬪閸婄厧鍟撻柨鐔告灮閹风兘鏁撻弬銈嗗閽€宥嗗闁跨喐鏋婚幏鐑芥晸閿燂拷 */		
    );
}
...
void init_clock(void)
{
    ...
    /* ??HDIVN?0,CPU????????闂佽法鍠撶粋宸僺t bus mode闂佽法鍣﹂幏锟�??闂佽法鍠撶粋鍧皔nchronous bus mode闂佽法鍣﹂幏锟� */
__asm__(
    "mrc    p15, 0, r1, c1, c0, 0\n"        /* ??????? */
    "orr    r1, r1, #0xc0000000\n"          /* ???闂佽法鍠撶粋鍧皔nchronous bus mode闂佽法鍣﹂幏锟� */
